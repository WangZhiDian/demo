 ...
 */
public class TKClassPathMapperScanner extends ClassPathBeanDefinitionScanner
{
	...
	public TKClassPathMapperScanner(BeanDefinitionRegistry registry)
	{
	...
	{
		this.mapperFactoryBean = (mapperFactoryBean != null ? mapperFactoryBean
