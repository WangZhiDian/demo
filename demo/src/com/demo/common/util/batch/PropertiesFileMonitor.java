...
public class PropertiesFileMonitor extends FileMonitor {
    ...
    public static void main(String args[]) {
        ...
        // 添加文件到监控中
        monitor.addFile(new File(fileName));

        // Avoid program exit
        while (true) {
            // 打印出ip对应属性值，检测是否变化
            System.out.println(monitor.getProperty(fileName, "giveChannelId"));
            // System.out.println(monitor.getProperty(fileName, "dbPassword"));
