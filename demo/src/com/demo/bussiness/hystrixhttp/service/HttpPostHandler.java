...
public class HttpPostHandler extends HystrixCommand<String>
{
	...
	public HttpPostHandler(HttpRequestInfo httpRequestInfo)
	{
		super(Setter.withGroupKey(HystrixCommandGroupKey.Factory.asKey("httpRequest"))
	    .andCommandKey(HystrixCommandKey.Factory.asKey("httpRequestpost"))
    ...
    {
		Request request=new Request.Builder().url(this.httpRequestInfo.getUrl()).post(this.httpRequestInfo.getBody()).build();
